		...
		<div class="row justify-content-center">
			<div class="col-md-5 mt-5">
				<div class="text-center text-white mb-5">
					<h4 class="font-size-18 font-weight-bold">SURAT KETERANGAN KELAHIRAN<br>(WARGA NEGARA INDONESIA)</h4>
				</div>
			</div>
			<div class="col-md-12">
				...
				<div class="row">
						...
						<div class="card radius-15">
							<form method="POST" action="reviewSKKEL">
								<div class="card-body">
									<div class="form-body">
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="number" maxlength="16" name="nik_bayi" id="nik_bayi" class="form-control" required>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="tempat_dilahirkan" id="tempat_dilahirkan" class="form-control" required>
													<option selected="" disabled="" value="">-- Pilih Tempat dilahirkan --</option>
													<option value="1">RS/SB</option>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="tempat_kelahiran" id="tempat_kelahiran" placeholder="Kabupaten / Kota" class="form-control" required>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Hari / Tanggal / Jam</label>
											<div class="col-sm-4">
											<input class="form-control" type="text" id="hari" name="hari" placeholder="Hari Lahir" readonly> 
											...
											<div class="col-sm-3">
												<input type="text" name="tgl_lahir" id="date" onchange="return data_hari();" placeholder="Tanggal Lahir" class="result form-control" required/>
											</div>
											<div class="col-sm-3">
												<input class="result form-control" type="text" name="waktu_lahir" id="time" placeholder="Jam Lahir" required> 
											</div>
										</div> 
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Jenis Kelahiran</label>
											<div class="col-sm-10">
												<select name="jenis_kelahiran" id="jenis_kelahiran" class="form-control" required>
													<option selected="" disabled="" value="">-- Pilih Jenis Kelahiran --</option>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="kelahiran_anak_ke" id="kelahiran_anak_ke" class="form-control" required>
													<option selected="" disabled="" value="">-- Pilih Kelahiran Anak ke --</option>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="penolong_kelahiran" id="penolong_kelahiran" class="form-control" required>
													<option selected="" disabled="" value="">-- Pilih Penolong Kelahiran --</option>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Berat Bayi</label>
											<div class="col-sm-4">
												<input type="text" name="berat_bayi" id="berat_bayi" placeholder="Kg" class="form-control" required>
											</div>
											<label class="col-sm-2 col-form-label">Panjang Bayi</label>
											<div class="col-sm-4">
												<input type="text" name="panjang_bayi" id="panjang_bayi" placeholder="Cm" class="form-control" required>
											</div>
										</div> 
										<!-- <div class="form-group row">
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
											<input class="form-control" type="text" id="alamat_ibu" name="alamat_ibu" placeholder="Blok" required> 
											</div>
											<div class="col-sm-3">
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<select name="wn_ibu" id="wn_ibu" class="form-control" required>
											...
											<div class="col-sm-5">
												<input type="text" name="kebangsaan" id="kebangsaan" value="INDONESIA" placeholder="Kebangsaan" class="form-control" required/>
											</div>
										</div> 

										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Tgl Pencatatan Perkawinan</label>
											<div class="col-sm-10">
												<input type="text" name="tanggalperkawinan_ibu" id="tanggalperkawinan_ibu" placeholder="Tanggal Pencatatan Perkawinan" class="result form-control" required/>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Alamat / RT / RW</label>
											<div class="col-sm-4">
											<input class="form-control" type="text" id="alamat_ayah" name="alamat_ayah" placeholder="Blok" required> 
											</div>
											<div class="col-sm-3">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Kewarganegaraan</label>
											<div class="col-sm-5">
												<select name="wn_ayah" id="wn_ayah" class="form-control" required>
													<option selected="" disabled="" value="">-- Pilih Kewarganegaraan--</option>
													<option value="1" selected>WNI</option>
													<option value="2">WNA</option>
												</select>
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Alamat / RT / RW</label>
											<div class="col-sm-4">
											<input class="form-control" type="text" id="alamat_pelapor" name="alamat_pelapor" value="<?= $pemohon['blok']; ?>" placeholder="Blok" required> 
											</div>
											<div class="col-sm-3">
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Alamat / RT / RW</label>
											<div class="col-sm-4">
											<input class="form-control" type="text" id="alamat_saksi1" name="alamat_saksi1" placeholder="Blok" required> 
											</div>
											<div class="col-sm-3">
								...
								<div class="card-body">
									...
									<div class="form-body">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Alamat / RT / RW</label>
											<div class="col-sm-4">
											<input class="form-control" type="text" id="alamat_saksi2" name="alamat_saksi2" placeholder="Blok" required> 
											</div>
											<div class="col-sm-3">
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(hasil, function(key, val) {
						...
						document.getElementById('alamat_ibu').value = val.blok;
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(hasil, function(key, val) {
						...
						document.getElementById('alamat_ayah').value = val.blok;
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(hasil, function(key, val) {
						...
						document.getElementById('alamat_saksi1').value = val.blok;
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(hasil, function(key, val) {
						...
						document.getElementById('alamat_saksi2').value = val.blok;
