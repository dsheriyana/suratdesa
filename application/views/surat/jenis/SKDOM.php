<body class="bg-forgot">
	<form autocomplete="off" action="reviewSKDOM" method="POST">
		<div class="book">
			<div class="page">
				...
				<div class="isisurat">
					...
					<div class="center">Nomor : 474.1/<input type="text" name="no_skdom" id="no_skdom" size="30px" value="<?= $no_surat; ?>/Ds.<?= getRomawi(date("m")); ?>/<?= date("Y"); ?>"></div>
					...
					<table style="width: 100%;">
						...
						<tr style="vertical-align:bottom">
							<td style="width:50%;text-align: center;">
								...
								<br />
								<br />
								<u><b><input type="text" name="pemohon_ttd" value="<?= $pemohon['nama']; ?>"></b></u>
							</td>
							<td style="width:50%;text-align: center;">
