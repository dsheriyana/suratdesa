<body class="bg-forgot">
	<form autocomplete="off" action="reviewSKU" method="POST">
		<div class="book">
			<div class="page">
				...
				<div class="isisurat">
					...
					<div class="center">Nomor : 503/<input type="text" name="no_sku" id="no_sku" value="<?= $no_surat; ?>/PEMDES/<?= date("Y"); ?>"></div>
					<div class="tab">
					...
					<div class="tab">
					<textarea id="keterangan" name="keterangan" cols="86" rows="5" required>	Orang yang namanya tersebut di atas adalah warga Desa Mekarmulya, pada saat ini yang 
					bersangkutan memiliki usaha di Bidang PERDAGANGAN ( pedagang pulsa,kuota dll ). Adapun Surat Keterangan Usaha ini dibuat guna melengkapi persyaratan pengajuan kredit ke bank.</textarea>
					</div>
					<div class="tab">
