<body class="bg-forgot">
	<form autocomplete="off" action="reviewSKAT" method="POST">
		<div class="book">
			<div class="page">
				...
				<div class="isisurat">
					...
					<div class="center">Nomor : 181.1/<input type="text" name="no_skat" id="no_skat" size="30px" value="<?= $no_surat; ?>/PEMDES/<?= date('Y'); ?>"></div>
					<div class="tab">
					...
					<div class="tab">
						Memiliki sebagian / sebidang tanah / rumah / tanah pekarangan / tanah bekas Hak Milik Adat berdasarkan SPPT/STTS No. : <input type="text" name="no_sppt" id="no_sppt" required> yang terletak di Blok <input type="text" name="letak_blok" id="letak_blok" required> Desa <?= $setting['nama_desa']; ?> Kecamatan <?= $setting['nama_kecamatan']; ?> Kabupaten Majalengka, dengan No. Persil <input type="text" name="no_persil" id="no_persil" required> Kelas <input type="text" name="kelas_persil" id="kelas_persil" required> luas <input type="number" name="luas_tanah" id="luas_tanah" required> m<sup>2</sup>, dengan batas tanah sebagai berikut:
					</div>
					...
					<div class="tab">
						Tanah tersebut diatas adalah mutasi Nama : <input type="text" name="nama_mutasi" id="nama_mutasi" required> dari hak bagi waris yang beralamatkan di
						Dusun <input type="text" name="dusun" id="dusun" required> RT <input type="text" name="rt" id="rt" required> RW <input type="text" name="rw" id="rw" required> Desa <input type="text" name="desa" id="desa" required> Kecamatan <input type="text" name="kecamatan" id="kecamatan" required> Kabupaten
						Majalengka, sejak tanggal <input type="text" class="datepicker" name="tgl_ketetapan" id="tgl_ketetapan" required> karena jual beli. Salinan F Desa/Induk C terlampir
