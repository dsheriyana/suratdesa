<body class="bg-forgot">
	...
	<div class="w-100">							
	<form method="POST" action="reviewSPPW">
		<div class="row justify-content-center">
			<div class="col-md-5 mt-5">
				<div class="text-center text-white mb-5">
					<h4 class="font-size-18 font-weight-bold">FORMULIR PERMOHONAN PINDAH WNI</h4>
					<input type="text" name="no_sppw" id="no_sppw" value=" 474.1/030/Pemdes/2021"  class="form-control" required>
				</div>
			</div>
			<div class="col-md-12">
