...
<page orientation="portrait" format="210x330" style="font-size: 10pt">
	...
	<p style="text-align: center;">
		<strong style="font-size: 12pt;">FORMULIR KETERANGAN PINDAH WNI</strong><br>
		<b>Antar Kecamatan Dalam Satu Kabupaten / Kota<br></b>
		<b>No. <?= $no_skpw; ?></b>
	</p>
...
<form id="formSubmit">
	...
	<input type="hidden" name="no_skpw" value="<?= $no_skpw; ?>">
...
<script>
	...
	const simpan_data = async (formData) => {
		let url = `${base_url}surat/reviewSKPW`;
